...
- **Last updated:** 2026-07-12 (manuscript polished — figure collision audit, abstract/first-paragraph indents, 'honest funnel'→'funnel', 'honest' prose thinned, STAT6 'falsified'→'ruled out' aligned; clean rebuild 32pp/0-err; operator reading main.pdf; continue next session)
