...
\textbf{The result is a null at the primary metric, and we report it straight.} Neither contrast separates from
...
than supplied by the referee. Two honest qualifications accompany the null rather than soften it. First,
...
bootstrap 95\% CIs; both cross zero (grey), so the joint outcome is a \emph{broad null}, reported straight. The
