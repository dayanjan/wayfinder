...
\item
  \textbf{Hop 2 --- program.} Th2-associated in the Ota contrast (\emph{z} = 7.71, adjusted \emph{p} = 1.96$\times$10\textsuperscript{-}\textsuperscript{1}\textsuperscript{3},
  log-fold-change +0.63; polarity marker-checked); not significant in the H\"{o}llbacher contrast --- one of
