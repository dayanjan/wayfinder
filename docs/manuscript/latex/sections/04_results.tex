...
committed analysis outputs, reproduced byte-for-byte inside the workbench (\S4.5).}
...
and improved the framing is the strongest available evidence that the reported quantities are a property of
